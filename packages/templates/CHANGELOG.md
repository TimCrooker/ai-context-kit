...
- b3bd7c6: Reject module `targets` that name a non-root target instead of silently dropping the module.
...
- Updated dependencies [b3bd7c6]
  - @timothycrooker/ai-context-core@1.4.0
